...
const setFavorite = async (user_id,media_item) => {
  logger.info('setFavorite id:',user_id,{ userId: req.meta.user_id })
...
const removeFavorite = async (user_id, media_item) => {
  logger.info('removefavorite id:',user_id,{ userId: req.meta.user_id })
...
const getAllFavorites = async (user_id) => {
  ...
  logger.info('getAllFavorites result:',result.rows,{ userId: req.meta.user_id })
